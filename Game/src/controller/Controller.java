...
public class Controller {
    ...
    private void createMatrix() {
        //Tạo ra một ma trận với row hàng và col cột
        ...
        /*Thêm các Icon vào listPoint với vị trí tương ứng với từng ô
        trong ma trận*/
        ...
        int i = 0;
        do {
            /*index là giá trị ngẫu nhiên từ 1 đến 21 - đây là giá trị của
            các ô trong ma trận dùng để so sánh với nhau*/
            int index = rand.nextInt(imgCount) + 1;
            if (arr[index] < max) {

                arr[index] += 2;
                /*Vòng For chạy từ j = 0 đến 2*/
                for (int j = 0; j < 2; j++) {
                    try {
        ...
        /*Với mỗi lần chạy của do while thì sẽ khởi tạo ra 2 giá trị ô mới của ma trận
        Vòng lặp sẽ kết thúc khi i = row*col/2. Cũng là khi mà ma trận đã nhận đủ giá trị cho tất cả các ô*/
    }
